...
class Exemplos_Menu:
    def __init__(self):
        ...
        menu_execucao = tk.Menu(menubar,tearoff=0)
        menu_execucao.add_command(label = "Executei")
        menu_execucao.add_command(label= "SABE MT")
        menu_execucao.add_command(label= "VAI TOMANDO")
        menubar.add_cascade(label = "Execução", menu= menu_execucao)
